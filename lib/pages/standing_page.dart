                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Week ${latest['week']}", style: const TextStyle(color: Colors.white70)),
                        ...
                        children: [
                          Column(
                            children: [
                              ...
                              Text('${latest['team_home_name']}', style: const TextStyle(color: Colors.white)),
                              const Text("Home", style: TextStyle(fontSize: 10, color: Colors.white70)),
                            ],
                          ),
                          Text(
                          ...
                          Column(
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text('${latest['team_away_name']}', style: const TextStyle(color: Colors.white)),
                              const Text("Away", style: TextStyle(fontSize: 10, color: Colors.white70)),
                            ],
                          ),
                        ],
                      ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: const [
                      Expanded(flex: 3, child: Text("Club", style: TextStyle(color: Colors.white70))),
                                ...
                                Expanded(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(team['team_name'], style: const TextStyle(color: Colors.white)),
                                    ],
                                  ),
                                ),
                                Expanded(
